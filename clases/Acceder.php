	...
	include('BD.php');
  	...
  	class Acceder
  	{
		...
		function buscar($strUsuario, $strContrasena)
  		{
			$SQL_Busq_Usuario =
			" 	SELECT usuario_id usuario_nombre, usuario_contrasenia, usuario_rol_id, rol_nombre, usuario_persona_id, usuario_estado
      			FROM usuario, rol
      			WHERE rol_id = usuario_rol_id AND usuario_nombre = '$strUsuario' AND usuario_contrasenia = '$strContrasena';
			";
			...
			$this->id_usuario = $obj_Usuario->usuario_nombre;
			$this->id_contrasena = $obj_Usuario->usuario_contrasenia;
			$this->id_rol = $obj_Usuario->usuario_rol_id;
			$this->id_persona = $obj_Usuario->usuario_persona_id;
			$this->estado = $obj_Usuario->usuario_estado;
		...
		function validarEstado($strUsuario, $strContrasena)
  		{
			...
			" 	SELECT usuario_id usuario_nombre, usuario_contrasenia, usuario_rol_id, rol_nombre, usuario_persona_id, usuario_estado
      			FROM usuario, rol
      			WHERE rol_id = usuario_rol_id AND usuario_nombre = '$strUsuario' AND usuario_contrasenia = '$strContrasena'AND usuario_estado = TRUE;
			";
